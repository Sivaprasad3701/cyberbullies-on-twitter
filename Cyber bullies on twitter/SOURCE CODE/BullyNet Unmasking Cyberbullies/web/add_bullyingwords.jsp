                ...
                <div class="wrap">
                    ...
                    <div class="login_form">
                        ...
                        <div class="login_form_right">
                            <form action="add_words.jsp" method="post">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div>
                                                    <label>Bullying word <span class="astrix">*</span></label>
                                                    <input type="text" name="bword" placeholder="Enter Bullying Word" required="">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                ...
                                                <a href="add_dataset.jsp">Add Dataset</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>   
