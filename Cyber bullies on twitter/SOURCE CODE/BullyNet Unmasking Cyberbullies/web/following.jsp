            ...
            <div class="wrap">
                <div class="nav">
                    <ul class="navigation">
                        ...
                        <li>
                            <a href="following.jsp"><span class="menu-mid" style="color: red">Following</span></a>
                        </li>
                        <li>
            ...
            <div class="wrap">
                <div class="grids">
                    ...
                    <table id="customers">
                        ...
                        <td><center><img src="Getimage?id=<%=rs5.getString("fid")%>" width="150" height="120"></center></td>
                        </tr>
                        <%
                                }
                            } catch (Exception ex) {
