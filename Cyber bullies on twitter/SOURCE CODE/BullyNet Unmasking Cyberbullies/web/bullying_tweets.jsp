...
<html>
    ...
    <body>
                    ...
                    <ul class="navigation">
                        ...
                        <li>
                            <a href="bullying_tweets.jsp">
                                <span class="menu-mid" style="color: red">Bullying Tweets</span>
                            </a>
                        </li>
                        <li>
        ...
        <div class="content">
            <div class="wrap">
                <div class="grids">
                    <center><h3>Bullying Tweets</h3></center>
                    <table id="customers">
                        <tr>
                        ...
                        <%
                            ...
                            try {
                                ResultSet rs = st.executeQuery("SELECT * FROM tweet WHERE status = '1' ");
                                while (rs.next()) {
                        ...
                        <tr>
                            ...
                            <td><a href="block_user.jsp?uid=<%=rs.getString("uid")%>&uname=<%=rs.getString("username")%>"  class="button">Block</a></td>
                        </tr>
                        <%                                             }
                            } catch (Exception ex) {
                                ex.printStackTrace();
