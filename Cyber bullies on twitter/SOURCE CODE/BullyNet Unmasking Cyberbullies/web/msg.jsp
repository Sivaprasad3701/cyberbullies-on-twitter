                ...
                <div class="wrap">
                    ...
                    <div class="login_form">
                        ...
                        <div class="login_form_right">
                            ...
                            %>
                            <form method="post" action="Msg" enctype="multipart/form-data">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div>
                                                    <label>Enter Message :<span class="astrix">*</span></label>
                                                    <textarea  name="msg" placeholder="Type Message Here!" style="width: 360px;height: 80px;color: black;" required=""></textarea>
                                                </div>
                                                <div>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="submit" class="uiButton" value="Send">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>   
